                            ...
                            <form onSubmit={this.handleSubmit}>
                                ...
                                <div className="card container" style={{ padding: ".3em" }} data-type="selectors" name="FechaDeNacimiento" id="FechaDeNacimiento" >
                                    ...
                                    <div className="row" style={{ padding: "1em" }}>
                                        <select className="btn col-3 card" style={{ margin: "0 .4em 0 0" }} aria-label="Día" name="Dia" id="Dia" title="Día" value={this.state.Dia} onChange={this.handleChange} required>
                                        ...
                                        <select className="btn col-3 card" aria-label="Año" name="Ano" id="Ano" title="Año" value={this.state.Ano} onChange={this.handleChange} required>
                    ...
                    <>
                        ...
                        <div className="container-fluid card" style={{ padding: "1em" }}>
                            <div className="container-fluid card card-title3">
                                Imprima este código QR y use el lector en la aplicación del Cliente Preferente para finalizar su registro.
                            </div>
                            <div className="container-fluid card">
                                <div>
                                    <QrGenerator codigo={qrMessage} onclick="window.print();return false;" />

                                    {/* <button onClick={this.handleChange.bind(this)} className="btn btn-outline-secondary no-print" id="imprimirCodigoQR" name="imprimirCodigoQR" value="Imprimir Codigo QR" style={{ width: "14em", marginBottom: "1em" }} ><i className="bi bi-printer-fill" />&emsp;Imprimir Código QR</button> */}
                                </div>
                            </div>
                        </div>
                    </>
