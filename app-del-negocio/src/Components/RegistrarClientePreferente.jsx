        ...
        return (
            <>
                <div className="container card" >
                    <h1 className="card card-title2" style={{ marginTop: ".4em", marginBottom: "0", borderRadius: "5px 5px 0 0" }}>APP DEL NEGÓCIO</h1>
                    <h1 className="card card-title3" style={{ borderRadius: "0 0 5px 5px" }}>Registrar Cliente Preferente</h1>
                    <div style={{ marginBottom: "2em" }}>
                        <div id="FormRegistrarSucursal" >
                            ...
                            <form onSubmit={this.handleSubmit}>
                                ...
                                <span className="card" style={{ textAlign: 'left', padding: "12px", marginTop: "1em" }} data-type="selectors" name="FechaDeNacimiento" id="FechaDeNacimiento" >
